...
function (label = "dynamicGraph", width = 400, height = 400, 
    ...
    overlaying = TRUE, diagonal = TRUE, N = 3, vertexClasses = validVertexClasses(), 
    factorClasses = validFactorClasses(), edgeClasses = validEdgeClasses(), 
    viewClasses = validViewClasses(), drawBlockFrame = TRUE, 
    drawBlockBackground = FALSE, useNamesForLabels = TRUE, namesOnEdges = TRUE, 
    updateEdgeLabels = TRUE, enterLeaveUpdate = TRUE, updateAllViews = TRUE, 
    saveTkReferences = TRUE, saveFunctions = TRUE, returnNull = FALSE, 
    hasMethods = TRUE, variableFrame = TRUE, debug.strata = FALSE, 
    debug.edges = FALSE, debug.position = FALSE, debug.update = TRUE, 
    ...) 
{
    args <- list(...)
    ...
    list(label = label, width = width, height = height, w = w, 
        ...
        overlaying = overlaying, diagonal = diagonal, N = N, 
        vertexClasses = vertexClasses, factorClasses = factorClasses, 
        edgeClasses = edgeClasses, viewClasses = viewClasses, 
        drawBlockFrame = drawBlockFrame, drawBlockBackground = drawBlockBackground, 
        useNamesForLabels = useNamesForLabels, namesOnEdges = namesOnEdges, 
        updateEdgeLabels = updateEdgeLabels, enterLeaveUpdate = enterLeaveUpdate, 
        updateAllViews = updateAllViews, saveTkReferences = saveTkReferences, 
        saveFunctions = saveFunctions, returnNull = returnNull, 
        variableFrame = variableFrame, hasMethods = hasMethods, 
