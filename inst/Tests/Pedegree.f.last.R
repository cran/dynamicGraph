...
# Test with block recursive model, vertices after blocks:

source("startup.0.R")

Block.tree <- 
 list(f = 0.08, F = 0.15, horizontal = FALSE, label = "Pedegree.f.last",
